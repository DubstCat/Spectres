...
namespace Spectres
{
    public partial class FormRazdel2 : Form
    {
        ...
        public FormRazdel2(MathCad mathCad, double[] M, int N)
        {
            ...
            chartE2.ChartAreas[0].AxisX.Minimum =  -mathCad.K / mathCad.tau;
            chartE2.ChartAreas[0].AxisX.Maximum = mathCad.K / mathCad.tau;
            chartE2.ChartAreas[0].AxisX.Interval = mathCad.K / mathCad.tau / 5;
            chartE2.ChartAreas[0].AxisX.MajorGrid.Interval = mathCad.K / mathCad.tau / 5;
            ...
            chartO2.ChartAreas[0].AxisX.Minimum =  -mathCad.K / mathCad.tau;
            chartO2.ChartAreas[0].AxisX.Maximum = mathCad.K / mathCad.tau;
            chartO2.ChartAreas[0].AxisX.Interval = mathCad.K / mathCad.tau / 5;
            chartO2.ChartAreas[0].AxisX.MajorGrid.Interval = mathCad.K / mathCad.tau / 5;
